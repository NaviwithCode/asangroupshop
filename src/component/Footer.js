...
//       <h4 className='text-center'>All Right Reserved &copy; MVA Graoup</h4>
//     </div>
//   )
// }
...
export const ResourcesLink=[
    ...
    {
        title:"Subscribe ASAN Digital Marketing",
        link:"https://www.youtube.com/@ASANDigitalMarketing/",
    },
]
const Footer = () => {
  return (
    ...
    //           </h1>
    //           <p>
    //           Welcome to ASAN Group Shop, your one-stop destination for all your ecommerce needs. ASAN Group Shop was founded with the mission to provide high-quality products and exceptional service to our customers.{""}
    //           </p>
    //           <br />
    //           {/* social media handel */}
    ...
    //               <ul className="">
    //                 <li className="hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-400 py-2 text-sm">
    ...
    //                   <li
    //                     key={link.title}
    //                     className=" cursor-pointer hover:translate-x-1 duration-300 hover:!text-primary space-x-1 text-gray-400 py-2 text-sm"
    //                   >
    ...
    // </>
    <footer class="w-full">
    <div class="mx-auto !bg-black !text-white max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* <!--Grid--> */}
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0">
                ...
                <h1>ASAN Graoup Shop</h1>
                 {/* </svg> */}
                </a>
                <p class="py-4 text-sm text-gray-500 lg:max-w-xs text-center lg:text-left">Welcome to ASAN Group Shop, your one-stop destination for all your ecommerce needs. ASAN Group Shop was founded with the mission to provide high-quality products and exceptional service to our customers.</p>
            ...
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-3"><a href="/about"  class="text-gray-600 hover:text-gray-300">About</a></li>
                    <li class="mb-3"><a href="/products"  class=" text-gray-600 hover:text-gray-300">Product</a></li>
                    <li><a href="/contact"  class=" text-gray-600 hover:text-gray-300">Contact</a></li>
                </ul>
            </div>
            {/* <!--End Col--> */}
            <div class="lg:mx-auto text-left ">
                ...
                <ul class="text-sm  transition-all duration-500">
                    <li class="mb-6"><a href=""  class="text-gray-600 hover:text-white">Customer Support</a></li>
                    <li class="mb-6"><a href="terms-conditions"  class=" text-gray-600 hover:text-white">Terms & Conditions</a></li>
                    <li><a href="policy"  class=" text-gray-600 hover:text-white">Privacy Policy</a></li>
                </ul>
            </div>
            {/* <!--End Col--> */}
            {/* <div class="lg:mx-auto text-left ">
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span class="text-sm text-gray-500 ">©<a href="/">ASAN Group Shop</a> 2025, All rights reserved.</span>
