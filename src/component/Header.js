...
const Header = () => {
  ...
  return (
    ...
    <button type="button" class="text-white text-sm max-sm:my-2">
      ...
      nabiullahansari4321@gmail.com</a>
    </button>
    </section>
      ...
      <div class="flex flex-wrap justify-center px-10 py-3 relative">
        ...
        >
          ...
          >
            ...
            <ul class={`lg:flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-white top-0 left-0 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 ${visible? "max-lg:min-w-[280px]" : "w-0"}`}>
            <MdClose  onClick={() => setVisible(false)} className="flex ml-auto mt-3 mr-3 shadow-sm rounded-md"/>
            <li class="max-lg:border-b  max-lg:px-3 max-lg:py-3">
              <a
                href="/"
                class="hover:text-[#007bff] text-gray-800 block text-[15px]"
