        ...
        {products?.map((p) => (
            <tr  class="bg-white border-b cursor-pointer dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="flex items-center mt-6 px-6 py-4">
                ...
                <a type="sumbit" onClick={()=>{window.location.reload(); handleDelete(p._id)}} class="font-medium text-red-600 dark:text-red-500 hover:underline cursor-pointer ms-3">Remove</a>
                {/* <button
                  type="submit"
